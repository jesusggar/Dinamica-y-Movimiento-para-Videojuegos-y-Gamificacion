...
############################################################
def aplicar_rodadura(body, R, Crr=0.02, dt=1/60.0):
	"""
	...
	N = abs(body.mass * 900) # 900 es tu gravedad actual
	torque_rodadura_max = Crr * N * R
...
def run_simulation():
	...
	while running:
		...
		#aquí se aplica la rodadura
		aplicar_rodadura(body, R, Crr=0.02, dt=1/60.0)
		space.step(1/60.0)
